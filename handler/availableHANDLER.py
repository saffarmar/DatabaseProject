...
class SupplierHandler:
    ...
    def build_resource_attributes(self, rid, type, amount, reservable, price, restime):
        result = {}
        result['rid'] = rid
        result['type'] = type
    ...
    def getSupplierByResourceId(self, pid):
        ...
        if not dao.getAvailableById(pid):
            return jsonify(Error="Part Not Found"), 404
        suppliers_list = dao.getSupplierByPartId()
        result_list = []
    ...
    def insertResource(self, form):
        ...
        if len(form) != 4:
            ...
            if type and amount and restime and reservable and price:
                ...
                result = self.build_resource_attributes(rid, type, amount, reservable, price, restime)
