...
class BatteryDao:
    ...
    def addBattery(self, rid, brand, exdate, size):
        cursor = self.conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor)
        query = "INSERT INTO batteries(rid, brand, exdate, size) VALUES (%s, %s, %s, %s) RETURNING rid;"
        cursor.execute(query, (rid, brand, exdate, size))
