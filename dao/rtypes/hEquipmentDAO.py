...
class HeavyEquipmentDao:
    ...
    def addHeavyEquipment(self, rid, erequirement, etype, weight, age, brand):
        cursor = self.conn.cursor(cursor_factory=psycopg2.extras.RealDictCursor)
        query = "INSERT INTO heavyEquipment(rid, erequirement, etype, weight, age, brand) VALUES ( %s, %s, %s, %s, %s, %s);"
        cursor.execute(query, (rid, erequirement, etype, weight, age, brand))
